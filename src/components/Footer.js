...
const  Footer = React.forwardRef((props,ref)=>{
  return(<div ref={ref} className='footer'>
...
<a className="in" href="www.linkedin.com/in/subramanian-m-b8b054250">
<svg href="" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-linkedin" viewBox="0 0 16 16">
